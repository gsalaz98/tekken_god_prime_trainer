...
pub fn get_damage_received(handle: &ProcessHandle, player_base_address: MemoryAddresses) -> std::io::Result<u32> {
...
pub fn get_player_char_id(handle: &ProcessHandle, player_base_address: MemoryAddresses) -> std::io::Result<u16> {
