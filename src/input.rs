...
pub fn get_inputted_attack(handle: &ProcessHandle, player_base_address: MemoryAddresses) -> std::io::Result<u16> {
...
pub fn get_inputted_direction(handle: &ProcessHandle, player_base_address: MemoryAddresses) -> std::io::Result<u16> {
